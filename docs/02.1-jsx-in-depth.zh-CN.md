...
当显示名称没有定义时，JSX 会根据变量赋值来推断类的 [显示名称](/docs/component-specs.html#displayname) :
...
如果你要使用 JSX，这篇 [新手入门](/docs/getting-started.html) 教程来教你如何搭建环境。
...
> 注意:
>
> JSX 类似于 HTML，但不完全一样。参考 [JSX 陷阱](/docs/jsx-gotchas-zh-CN.html) 了解主要不同。

...
내부적으로 믹스인은 현재의 props와 state를 다음 값과 비교하여 같다면 `false`를 반환하도록 [shouldComponentUpdate](/docs/component-specs-ko-KR.html#updating-shouldcomponentupdate)를 구현합니다.

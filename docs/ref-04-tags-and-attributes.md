...
> Note:
>
> All attributes are camel-cased, to match the DOM API specification with the exception of `for`, which becomes `htmlFor`.
> *For React.js users, `class` will work as an attribute in the dsl.*

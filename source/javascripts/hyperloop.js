...
Opal.modules["hyperloop/application/boot"] = function(Opal) {
  ...
  Opal.add_stubs(['$<<', '$receivers', '$set_var', '$attr_reader', '$new', '$each', '$call']);
  return (function($base) {
    var $Hyperloop, self = $Hyperloop = $module($base, 'Hyperloop');
    ...
    if ((($a = ($scope.Operation != null)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      (function($base, $super) {
        ...
        return (function(self) {
          var $scope = self.$$scope, def = self.$$proto, TMP_1, TMP_3;
...
if (cur_errors == null) cur_errors = nil;if (part == null) part = nil;
      ...
      (function(self) {
        var $scope = self.$$scope, def = self.$$proto, TMP_9, TMP_11, TMP_12, TMP_13, TMP_14, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_21, TMP_22, TMP_23, TMP_36;
...
if (key == null) key = nil;
        ...
        return (Opal.defn(self, '$inherited', TMP_36 = function $$inherited(child) {
...
if (key == null) key = nil;
          ...
          return ($a = ($i = child.$singleton_class()).$define_singleton_method, $a.$$p = (TMP_32 = function(){var self = TMP_32.$$s || this, $j, $k, TMP_33;

          return ($j = ($k = (($scope.get('Hyperloop')).$$scope.get('Context'))).$set_var, $j.$$p = (TMP_33 = function(){var self = TMP_33.$$s || this, $l, $m, TMP_34, my_super = nil;

            my_super = ((($l = self.$superclass()) !== false && $l !== nil && $l != null) ? $l : (self.$$singleton_of).$superclass().$singleton_class());
              if (my_super['$==']($scope.get('Operation').$singleton_class())) {
                return $scope.get('Class').$new($scope.get('Railway'))
                } else {
                return ($l = ($m = $scope.get('Class').$new(my_super.$_Railway())).$tap, $l.$$p = (TMP_34 = function(wrapper){var self = TMP_34.$$s || this, $n, $o, TMP_35;
if (wrapper == null) wrapper = nil;
                return ($n = ($o = ["@validations", "@tracks", "@receivers"]).$each, $n.$$p = (TMP_35 = function(var$){var self = TMP_35.$$s || this, $p, value = nil;
if (var$ == null) var$ = nil;
                  value = my_super.$_Railway().$instance_variable_get(var$);
                    return wrapper.$instance_variable_set(var$, (($p = value !== false && value !== nil && value != null) ? value.$dup() : value));}, TMP_35.$$s = self, TMP_35.$$arity = 1, TMP_35), $n).call($o)}, TMP_34.$$s = self, TMP_34.$$arity = 1, TMP_34), $l).call($m)
              };}, TMP_33.$$s = self, TMP_33.$$arity = 0, TMP_33), $j).call($k, self, "@_railway")}, TMP_32.$$s = self, TMP_32.$$arity = 0, TMP_32), $a).call($i, "_Railway");
        }, TMP_36.$$arity = 1), nil) && 'inherited';
      })(Opal.get_singleton_class(self));
      ...
      return (function($base, $super) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_37;

        return (Opal.defn(self, '$initialize', TMP_37 = function $$initialize(operation) {
          var self = this;

          return self.operation = operation;
        }, TMP_37.$$arity = 1), nil) && 'initialize'
      })($scope.base, null);
    })($scope.base, null)
  })($scope.base)
};
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      return (function($base, $super) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_22, TMP_23, TMP_26;
        ...
        return (Opal.defs(self, '$params_wrapper', TMP_26 = function $$params_wrapper() {
          var $a, $b, TMP_24, self = this;

          return ($a = ($b = (($scope.get('Hyperloop')).$$scope.get('Context'))).$set_var, $a.$$p = (TMP_24 = function(){var self = TMP_24.$$s || this, $c, $d, TMP_25;

          if ($scope.get('Railway')['$=='](self.$superclass())) {
              return $scope.get('Class').$new($scope.get('ParamsWrapper'))
              } else {
              return ($c = ($d = $scope.get('Class').$new(self.$superclass().$params_wrapper())).$tap, $c.$$p = (TMP_25 = function(wrapper){var self = TMP_25.$$s || this, $e, hash_filter = nil;
if (wrapper == null) wrapper = nil;
              hash_filter = self.$superclass().$params_wrapper().$hash_filter();
                return wrapper.$instance_variable_set("@hash_filter", (($e = hash_filter !== false && hash_filter !== nil && hash_filter != null) ? hash_filter.$dup() : hash_filter));}, TMP_25.$$s = self, TMP_25.$$arity = 1, TMP_25), $c).call($d)
            }}, TMP_24.$$s = self, TMP_24.$$arity = 0, TMP_24), $a).call($b, self, "@params_wrapper");
        }, TMP_26.$$arity = 0), nil) && 'params_wrapper';
      })($scope.base, null);
    })($scope.base, null)
  })($scope.base)
};

...
Before continuing, you will need a Rails app with Hyperloop and Devise setup and working. [Either clone the source code](https://github.com/ruby-hyperloop/hyperloop-devise-tutorial) of this tutorial or run through the setup steps detailed here.

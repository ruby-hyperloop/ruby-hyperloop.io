...
Hyperloop has been tested with the most recent Ruby On Rails verions:<br> Rails (~> 4.2), Rails (~> 5.0) and the last Rails (5.1.0.rc1). Because the final Rails 5.1.0 is not released yet there are still few points to be aware of [Hyperloop and Rails 5.1.0.rc1](/installation-rails5.1.0.rc1) 
